...
```{r}
ggplot(d, aes(x = mean, y = lang_bias, color = sex, group = sex)) +
  geom_smooth(method = "lm") +
...
#compute.es::mes(0.3878186, 0.3623428, 0.02424421, 0.02142372, 16, 11 )

#compute.es::mes(0.3709505, 0.3077983,  0.03150937, 0.04381712, 16, 11 )
```
