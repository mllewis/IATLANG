...
```{r}
CAREER_NEW_ES <- "es_career_separate_no_pronouns.csv"
...
ggplot(career_behavioral %>% filter(!is.na(es_hand_translation_new)), aes(x = es_behavioral_iat_weighted, 
...
### Previous language ES vs. new
```{r}
GENIUS_NEW_ES <- "es_genius_separate_no_pronouns.csv"
