...
FULL_IAT_MODEL_PATH <- here("data/study1b/wiki_subsetted_models/calculated/wiki.")
OUTMODEL_PREFIX <- here("data/study2/wiki_calculated_models/")
...
save_subsetted_model_occupation <- function(current_lang, trans_df, model_prefix, other_target_words,
  ...
  write_csv(all_calcuated_vectors, paste0(out_model_prefix, "/wiki.", 
