...
```{r}
d_raw <- read_lines("/Users/mollylewis/Documents/research/Projects/IATLANG/analyses/childrens_books/100Books.txt")  %>%
  as.data.frame() %>%
  rename("text" = ".")  %>%
...
write_delim(d_raw, "/Users/mollylewis/Documents/research/Projects/IATLANG/analyses/childrens_books/100Books_clean.txt")
