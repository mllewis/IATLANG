...
RAW_BEHAVIORAL_CONF <- here("data/study1c/processed/tidy_behavioral_iat_data_confirmatory_full.csv") #here("data/study1c/processed/tidy_behavioral_iat_data_confirmatory_full.csv")
OUTFILE <- here("data/study1c/processed/long_form_confirmatory_behavior_and_language.csv")  # here("data/study1c/processed/long_form_confirmatory_behavior_and_language.csv")
