...
ANCHOR_PATH <- here("data/study3_SI/study2_replication/wiki_native_calculated_models/")
OUTFILE  <-  here("data/study3_SI/study2_replication/wiki_native_occupation_gender_score.csv")
