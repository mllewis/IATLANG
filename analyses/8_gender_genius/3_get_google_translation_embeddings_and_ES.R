...
OUTPUT_PATH <- "genius_effect_sizes_google_full.csv"
...
word_list <- list(test_name = "genius_gender", 
                  ...
                  attribute_1 = c("genius", "brilliant", "super smart", "knowledgable", "wise", 
                                  "brainy", "insightful", "clever"),
                  attribute_2 = c("creative", "artistic", "super imaginative", "expressive", "inspired", "masterful", 
                                  "innovative", "artsy"))
...
effect_sizes <- map_df(TARGET_GOOGLE_LANGS, get_wiki_es)
