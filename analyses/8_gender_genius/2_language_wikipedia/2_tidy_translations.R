...
OUTFILE <- "data/tidy_iat_translations.csv"
INFILE <- "data/iat_translations.csv"
...
GENDERED_WORDS <- c("executive", "professional", "management", "parents", "children", 
                  "family", "cousins", "relatives", "creative", "artistic",
                  "super-imaginative",
                  "genius", "brilliant", "super-smart")
