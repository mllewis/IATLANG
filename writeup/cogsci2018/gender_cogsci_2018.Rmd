...
country_means_career_implicit_with_index <- country_means_career_implicit %>%
  left_join(wps) %>%
  mutate(country_name2 = ifelse(country_name %in% c("Afghanistan", "India", "Netherlands", "Portugal", "China", "United States of America", "Sweden", "Hungary", "Philippines", "Colombia", "UK"), country_name, ""),
...
Our pattern of findings closely replicates what has been previously reported in the literature. (correlation)

But what is novel is the WPS correlation - surprising!
...
goes the opposition direction:  greater psychological gender biases cause greater gender biases becoming encoded in the statistics of the language. In Study 3, we test the language-causal hypothesis more directly by examining whether there is a
relationship between psychological gender bias and language along a
linguistic dimension that is unlikely to be a subject of rapid change -- namely,
