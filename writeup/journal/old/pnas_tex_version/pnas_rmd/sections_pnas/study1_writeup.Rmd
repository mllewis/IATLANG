...
glasgow_norms <- read_csv(GENDER_NORMS) %>%
  ...
  mutate(word =  str_split(word, " ", simplify = T)[1],
         word = tolower(word)) %>%subt_p <- round(p_value(boot_mediation_model_subt), 2)
...
pdf("/Users/mollylewis/Documents/research/Projects/1_in_progress/IATLANG/writeup/journal/old/pnas_tex_version/pnas_rmd/iat_lang_pnas_files/figure-latex/study1_fig.pdf", width = 10.25, height = 4.5)
