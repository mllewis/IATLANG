...
```
<br>
**Study 2 occupational items.** In Study 2, we selected 20 occupation labels from the set of items used in Misersky, et al. (2014)$^{47}$. The table presents the 20 items along with their perceived gender bias as reported in Misersky, et al. (2014; larger values indicate occupation is perceived to be more closely associated with females).
