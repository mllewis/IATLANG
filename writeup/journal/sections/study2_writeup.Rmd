...
```{r, fig.pos = "!t!", fig.height = 4, fig.width = 4, fig.cap = "Residualized behavioral IAT gender bias as a function of the proportion of gender-distinct labels for set of words referring to occupations. Error bands indicate standard error of the model estimate."}
