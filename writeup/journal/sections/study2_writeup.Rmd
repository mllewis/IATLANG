...
```{r}
# implicit
lm(es_iat_sex_age_order_implicit_resid ~ wikipedia_grammar_type2 + median_country_age,weights = n_participants,
       data = all_es) %>%
  summary()
...
# explicit
lm(es_iat_sex_age_order_explicit_resid ~ empirical_binary_grammatical_gender + wikipedia_grammar_type2 + median_country_age, data = all_es) %>%
  summary()
