...
We identified 20 words referring to occupations that were relatively high-frequency and balanced for their perceptions of gender bias in the workforce, based on previously-collected gender perception norms  [@misersky2014norms]. We then translated these words into each of the 26 languages in our sample, distinguishing between male and female forms where present. Forms were translated by consulting native speakers or English translation dictionaries.
...
tidy_corrs_to_print_reordered <- tidy_corrs_to_print[c(8,9,6,1,2,4,5,7,3),] %>% select(` `, "Residualized Behavioral IAT", "Residualized Explicit Bias",
                                                                                       "Percent Women in STEM","Language IAT (Subtitles)", "Language IAT (Wikipedia)", "Prop. Gender-Neutral Labels", "Occupation Bias (Subtitles)","Occupation Bias (Wikipedia)", "Median Country Age")
