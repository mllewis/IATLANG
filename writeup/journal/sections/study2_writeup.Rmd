...
If language statistics play a causal role in shaping psychological gender biases, we predicted that those statistics would be exaggerated in cases of explictly-marked gender distinctions on nouns referring to people. Languages make gender distinctions on words referring to people in way that is congruent with indicate the biological sex of the referent, as in  "waiter" versus "waitress" in English. We hypothesized that the presence of these kinds of distinctions might *lead to* more gender biased language statistics for those words. This prediction is a stronger test of the language-as-causal hypothesis because these gender markings are fossilized as part of the lexicon, and thus less likely to be caused by people's gender biases. 
