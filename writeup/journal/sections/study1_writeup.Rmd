...
iat_behavioral_es <- read_csv(BEHAVIORAL_IAT_PATH) %>%
  ...
  select(language_code,language_name, median_country_age, 
...
# Croatian, Greekx, Hindi, Hungaraianx, Zulu, Tagalog, Thai, Vietnamese, Malaysian, Mandarin, Indonesianx, Turkishx
