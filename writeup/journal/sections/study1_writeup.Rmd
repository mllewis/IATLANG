...
L_B_sub <- text_tidy_corrs %>%
  filter(rowname ==  "Language IAT (Subtitle)", var2 == "Residualized Implicit Bias") %>%
  pull(r_print_text)

L_B_wiki <- text_tidy_corrs %>%
  filter(rowname ==  "Language IAT (Wikipedia)", var2 == "Residualized Implicit Bias") %>%
  pull(r_print_text)
