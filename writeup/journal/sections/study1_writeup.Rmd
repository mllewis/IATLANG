...
lang_mod <- lm(lang_es_sub~es_iat_sex_age_order_implicit_resid,all_es_tidy_scaled)
               
iat_mod <- lm(es_iat_sex_age_order_implicit_resid ~ lang_es_sub,all_es_tidy_scaled) 

all_es_tidy_scaled_resids <- all_es_tidy_scaled %>%
  modelr::add_residuals(lang_mod, "lang_sub_mod_resid") %>%
  modelr::add_residuals(iat_mod, "iat_sub_mod_resid")

cor.test(all_es_tidy_scaled_resids$lang_sub_mod_resid, all_es_tidy_scaled_resids$per_women_stem_2012_2017)

cor.test(all_es_tidy_scaled_resids$iat_sub_mod_resid, all_es_tidy_scaled_resids$per_women_stem_2012_2017)
...
boot_mediation_model_wiki <- all_es_tidy_scaled %>%
  fit_mediation(
    x = "lang_es_wiki",
...
round(p_value(boot_mediation_model_wiki), 2)


boot_mediation_model_sub <- all_es_tidy_scaled %>%
  fit_mediation(
    x = "lang_es_sub",
    y = "per_women_stem_2012_2017",
    m = "es_iat_sex_age_order_implicit_resid") %>%
...
psych::mediate(per_women_stem_2012_2017 ~ lang_es_wiki + (es_iat_sex_age_order_implicit_resid), data =all_es_tidy_scaled)


psych::mediate(per_women_stem_2012_2017 ~ lang_es_sub + (es_iat_sex_age_order_implicit_resid), data =all_es_tidy_scaled)


round(p_value(boot_mediation_model_sub), 2)
