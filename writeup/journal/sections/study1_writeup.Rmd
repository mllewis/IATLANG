...
lm(per_women_stem_2012_2017 ~ lang_bias, data = sub) %>%
  summary()

lm(per_women_stem_2012_2017 ~ lang_bias, data = sub, weights = file_size) %>%
  summary()

lm(per_women_stem_2012_2017 ~ lang_bias + median_country_age, data = sub, weights = file_size) %>%
  summary()

lm(per_women_stem_2012_2017 ~ lang_bias, data = wiki) %>%
  summary()

lm(per_women_stem_2012_2017 ~ lang_bias, data = wiki, weights = file_size) %>%
  summary()
