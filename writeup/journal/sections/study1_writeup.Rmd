...
all_corr_vars <- all_es_tidy %>%
  select(lang_es_sub, lang_es_wiki,subt_gender_diff_score_fm_abs, wiki_gender_diff_score_fm_abs, mean_prop_distinct_occs, es_iat_sex_age_order_explicit_resid, 
