...
<!--[ML] Here's the relevant ref to this: https://www.projectimplicit.net/nosek/iat/harvesting.GroupDynamics.pdf, but it's not obvious to me from their description exactly how they calculated the explicit score. They say: "Before performing each IAT, respondents completed a single-item (5-point scale) measure of explicit attitude or belief toward the attitude or belief object.," but don't say exactly what the question was. And, both questions (i.e, How strongly do you associate career and family with males and females?, and 
How strongly do you associate career and family with males and females?) are present in the dataset -->
...
<!-- [ML] yes. All measures of implicit bias control for age, gender, block order. -->
