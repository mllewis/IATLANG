# Description of Cross-Cultural IAT data
...
```{r}
BY_PARTICIPANT_DF <-  "../../../data/study0/processed/by_participant_df.csv"
...
## Results
```{r mapplot, fig.env="figure", fig.pos = "t", fig.align='center', fig.cap = "Residualized gender bias by country as measured by the IAT (Study 1). Larger values indicate a larger bias to associate women with the concept of family and men with the concept of career."}
