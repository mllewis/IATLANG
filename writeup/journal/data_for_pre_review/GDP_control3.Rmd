...
* Result with respect to language bias:  A more plausible causal model is language -> preferences -> GDP. That data support this. This also holds for the wikipedia model. Also holds for ggi, hdi_value and per_women_stem.
