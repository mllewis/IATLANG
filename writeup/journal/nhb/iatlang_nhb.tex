...
%smaller gender biases tended to have more women in STEM fields (\emph{r}(31) = -0.54 {[}-0.75, -0.24{]}, \emph{p} = 0). In contrast, there was no
...
All statistical tests reported are two-sided analyses. Effect size measure are classic Cohen's d measure. Brackets indicate 95\\\% confidence interveals. Two-sample t-test are calculated using Welch's test. LMER. 
