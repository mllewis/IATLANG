...
study1_plot2 <- ggplot(es_iat_tidy, aes(x = lang_diff, y = behavioral_resid_diff)) +
 ...
 scale_y_continuous(breaks = c( -.2,-.1, 0, .1, .2, .3), 
  ...
  ggtitle("Psychological and Linguistic Biases in\nBritish and American Participants") +
  theme_classic(base_size = 12) +
  theme(axis.line = element_line(size = .8))

pdf("/Users/mollylewis/Documents/research/Projects/1_in_progress/IATLANG/writeup/journal/pnas_tex_version/pnas_rmd/iat_lang_pnas_files/figure-latex/study1_fig.pdf", width = 10.25, height = 4.5)
