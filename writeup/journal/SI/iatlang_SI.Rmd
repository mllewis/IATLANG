...
implicit_gdp <- cor.test(other_data$es_iat_sex_age_order_implicit_resid,
                         other_data$gdp_2017) %>%
  tidy() %>%
  tidy_r_to_text_r()
